...
<aside class="right-side">                
	...
	<section class="content">
		...
		<h5>This report mainly showing a report related to sales where the measure taken is a total of purchased computer.</h5>
		<div class="row">
            <div class="col-md-12">
                <!-- Bar chart -->
...
<script src="../../dwhproject/media/js/ContentJS/summary/summarySales.js"></script>